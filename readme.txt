...
= Basic Installation =
1. Download and unzip the current version of the CONTUS HD FLV Player plugin.
2. Transfer the entire contus-hd-flv-player directory to your `/wp-content/plugins/` directory
