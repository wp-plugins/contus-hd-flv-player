 ...
 * Description: Simplifies the process of adding  to a WordPress blog. Powered by Apptha.
...
function HDFLV_Render($arguments= array()) {
    ...
    global $videoid, $site_url ,$dirPage;
...
function HDFLVAddPage() {
    ...
    add_menu_page(__('hdflv', 'hdflv'), __('HDFLVPlayer', 'hdflv'), 2, "hdflv", "show_menu", get_bloginfo('url') . "/wp-content/plugins/contus-hd-flv-player/images/apptha.png");
    
    add_submenu_page( "hdflv", __('HDFLV Videos', 'hdflv'), __('HDFLV Videos', 'hdflv'), 4, "hdflv", "show_menu");
    
    add_submenu_page( "hdflv", "HDFLV Options", "HDFLV Options", 4, "hdflvplugin.php", "FlashOptions");
}
...
?>
    ...
    <div class="wrap">
        <h2>HDFLVPlayer Options</h2><form method="post" enctype="multipart/form-data" action="admin.php?page=hdflv"><p>Welcome to the HDFLVPlayer plugin options menu! &nbsp;&nbsp;<input class="button-primary" type="submit" value="<?php _e('Add Video', 'hdflv') ?> &raquo;" name="show_add"/></p></form>
                    ...
                    <div class="portlet-content">
                        <table class="form-table">
                            <tr>
                                ...
                                <td><input type='text' name="width" value="<?php echo $fetchSettings->width ?>" size=45  />Note: Recommended width is 400. If you want your width less than 400, please disable few buttons in "Skin Configuration"</td>
                            ...
                            <tr>
                                ...
                                <td><input type='text' name="stagecolor" value="<?php echo $fetchSettings->stagecolor ?>" size=45  />
                                    <span  style="font-size: 9px;padding-left: 5px;" >Ex : 0xFFFFFF  </span> </td>
                            </tr>
                         <!--    <tr>
                          ...
                          <div class="portlet-content">
                              <table class="form-table">
                                  ...
                                  <tr>
                                      ...
                                      <td><input type='checkbox' class='check' name="download" <?php if ($fetchSettings->download == 1) { ?> checked <?php } ?> value="1" size=45  />&nbsp Note: Not supported for YouTube videos</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                      ...
                                      <td><input type='checkbox' class='check' name="embed_visible" <?php if ($fetchSettings->embed_visible == 1) { ?> checked <?php } ?> value="1" size=45  /></td>
                                  </tr>
                      ...
                      <div class="portlet">
                          <div class="portlet-header">Logo Configuration (Applicable Only For Licensed Player)
                            <?php if($fetchSettings->license == '' || $fetchSettings->license == '0'){?>
                              <a href="http://www.apptha.com/shop/checkout/cart/add/product/20" target="_blank" style="text-decoration: none;color:red;cursor:pointer;">Buy Now</a>
                              <?php }?>
                          </div>
                          ...
                          <div class="portlet-content">
                              <table class="form-table">
                                  ...
                                  <tr>
                                      ...
                                      <td><input type='checkbox' class='check' name="display_logo" <?php if ($fetchSettings->display_logo == 1) { ?> checked <?php } ?> value="1" size=45  /></td>
                                  </tr>
                              </table>
                          </div>
                      </div>
...
function HDFLVLoadDefaults() {
  global $wpdb;
  $insertSettings = $wpdb->query(" INSERT INTO " . $wpdb->prefix . "hdflv_settings
VALUES (1,1,1,1,1,0,1,'platoon.jpg','http://www.hdflvplayer.net/',50,'LR',1,1,0,20,1,'0x000000','skin_black',0,'hdflvplayer/url.php','playXml',1,1,1,1,1,500,400,1,0,0,'wp-content/uploads')");
}
